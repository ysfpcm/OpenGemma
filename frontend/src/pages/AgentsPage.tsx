...
import ToolsPicker from '../components/Agents/ToolsPicker';
...
export function AgentsPage() {
  ...
  // The app shell keeps the main scroll container mounted while routes change.
  // Reset it when entering the agents page or switching between the list and
  // an agent detail view so the page never opens halfway down the agent list.
  useLayoutEffect(() => {
  ...
  if (selectedAgent) {
    ...
    return (
      <div ref={pageScrollRef} className="flex-1 min-h-0 overflow-y-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8 lg:py-10">
  ...
  return (
    <div ref={pageScrollRef} className="flex-1 min-h-0 overflow-y-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8 lg:py-10">
        ...
        <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start gap-4">
          <div>
            ...
            <p className="text-sm mt-2 max-w-2xl" style={{ color: 'var(--color-text-secondary)' }}>
              Choose a ready-made agent, give it a name, and launch. Its schedule, behavior, and recommended tools are preloaded for you.
            </p>
          </div>
          <button
      ...
      {agentManagerAvailable === false && (
        <div
          className="mb-5 px-4 py-3 rounded-lg flex items-start gap-3 text-sm"
          style={{
